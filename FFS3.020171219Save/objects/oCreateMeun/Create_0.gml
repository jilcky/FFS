...
room_set_width(2408,2408)
ShowDebug(room_width)
...
#region 注册笔刷
PenNameMap = ds_map_create()
#region 墙体
var Part = "墙体"
//主part
ds_map_add_map(PenNameMap,Part,ds_map_create())
//子part
#region 通常墙体
	var Name = "通常墙体"
	var Map = ds_map_create()
	ds_map_add_map(PenNameMap[?Part],Name,Map)
	var SP = sNoSP
...
#region 透明
	var Name = "透明墙体"
	var Map = ds_map_create()
	ds_map_add_map(PenNameMap[?"墙体"],Name,Map)
	var SP = sNoSP
	ds_map_add(Map,"精灵",SP)
