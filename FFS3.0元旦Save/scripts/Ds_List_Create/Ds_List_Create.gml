...
var Name = "A"
var Str = "List"+"No."+string(ds_map_size(variable_instance_get(id,Name)))+" "+"ID:"+string(id)+" "+string(object_get_name(id.object_index))+" "+"事件："+string(event_type)+" "+date_datetime_string(date_current_datetime())
